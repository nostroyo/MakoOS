FILES = ./build/kernel.asm.o build/kernel.o ./build/idt/idt.asm.o ./build/idt/idt.o ./build/mem/mem.o ./build/IO/io.asm.o ./build/mem/heap/heap.o ./build/mem/heap/kheap.o ./build/mem/paging/paging.o ./build/mem/paging/paging.asm.o ./build/disk/disk.o ./build/fs/pparser.o ./build/string/string.o
INCLUDES = -I./src
